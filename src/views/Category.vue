      ...
      <div class="pages">
        <nav>
          <ul class="pagination">
            ...
            ><router-link @click="setPage(pageNumber)" class="page-link" :to="{path:`/${category}/page/${pageNumber}`}">{{pageNumber}}</router-link></li>
          </ul>
        </nav>
      </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    async function getCategory() {
      ...
      else if (data.name == "Keyboards") categoryName.value = "Клавиатуры";
